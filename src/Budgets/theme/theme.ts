...
const lightThemeOptions: ThemeOptions = {
    palette: {
        mode: 'light',
        primary: {
            main: '#c7d2fe', // Светлый приглушенный сине-серый (темнее)
            light: '#e8f4fd', // Очень светлый сине-серый
            dark: '#a5b4fc', // Средний приглушенный сине-серый
            contrastText: '#475569', // Средне-темный приглушенный сине-серый
        },
        secondary: {
            main: '#e2e8f0', // Светлый серо-голубой (темнее)
            light: '#f1f5f9', // Очень светлый бежевый/почти белый
            dark: '#cbd5e1', // Средний серо-голубой
            contrastText: '#475569', // Средне-темный приглушенный сине-серый
        },
        error: {
